...
public class ScaleGestureDetector {
     ...
     * <ul>
     *  <li>One {@link OnScaleGestureListener#onScaleBegin(com.example.macbookpro.advertisescreen.ScaleGestureDetector)}
     *  <li>Zero or more {@link OnScaleGestureListener#onScale(com.example.macbookpro.advertisescreen.ScaleGestureDetector)}
     *  <li>One {@link OnScaleGestureListener#onScaleEnd(com.example.macbookpro.advertisescreen.ScaleGestureDetector)}
     * </ul>
     */
    public interface OnScaleGestureListener {
         ...
         *          greater than 0.01.
         */
        public boolean onScale(View view, com.example.macbookpro.advertisescreen.ScaleGestureDetector detector);
         ...
         *          rest of the gesture.
         */
        public boolean onScaleBegin(View view, com.example.macbookpro.advertisescreen.ScaleGestureDetector detector);

        /**
         * Responds to the end of a scale gesture. Reported by existing
         * pointers going up.
         *
         * Once a scale has ended, {@link com.example.macbookpro.advertisescreen.ScaleGestureDetector#getFocusX()}
         * and {@link com.example.macbookpro.advertisescreen.ScaleGestureDetector#getFocusY()} will return the location
         * of the pointer remaining on the screen.
         *
         * @param detector The detector reporting the event - use this to
         *          retrieve extended info about event state.
         */
        public void onScaleEnd(View view, com.example.macbookpro.advertisescreen.ScaleGestureDetector detector);
    }
     ...
     * {@link OnScaleGestureListener#onScale(com.example.macbookpro.advertisescreen.ScaleGestureDetector)} returns
     * {@code false} so that a subclass can retrieve the accumulated scale
     * factor in an overridden onScaleEnd.
     * {@link OnScaleGestureListener#onScaleBegin(com.example.macbookpro.advertisescreen.ScaleGestureDetector)} returns
     * {@code true}.
     */
    ...
    private com.example.macbookpro.advertisescreen.Vector2D mCurrSpanVector;
    ...
    public ScaleGestureDetector(OnScaleGestureListener listener) {
        mListener = listener;
        mCurrSpanVector = new com.example.macbookpro.advertisescreen.Vector2D();
    }
    ...
    public com.example.macbookpro.advertisescreen.Vector2D getCurrentSpanVector() {
