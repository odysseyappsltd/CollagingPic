...
public class aspectActivityForFreeStyle extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aspect_for_free_style);
    ...
    public void aspect(View view){
        ...
        if(aspectratio != AspectData.getSharedInstance().getAspectValue()){
            ...
            NotificationCenter.broadcast(NotiData.getSharedInstance().TIME_TO_PICK_ASPECT_VALUE,aspectActivityForFreeStyle.this);
