...
public class GridViewAdapter extends ArrayAdapter<com.example.macbookpro.advertisescreen.Model_images> {
...
//    private final int[] images;
    ...
    ArrayList<com.example.macbookpro.advertisescreen.Model_images> al_menu = new ArrayList<>();
    int int_position;
...
//    }
    ...
    public GridViewAdapter(Context context, ArrayList<com.example.macbookpro.advertisescreen.Model_images> al_menu, int int_position) {
...
//        this.bool = bool;
    ...
    public int getCount() {
        ...
        if(int_position==0){
            return  com.example.macbookpro.advertisescreen.MainActivity.allImage.size();
        }
        else {
//            Log.e("ADAPTER LIST SIZE", al_menu.get(int_position).getAl_imagepath().size() + "");
    ...
    public int getViewTypeCount() {
        if(int_position==0){
            if(com.example.macbookpro.advertisescreen.MainActivity.allImage.size()>0) {
                return com.example.macbookpro.advertisescreen.MainActivity.allImage.size();
            }
            else {
                return 1;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(int_position==0){
            a= com.example.macbookpro.advertisescreen.MainActivity.allImage.get(position);
...
//           }
            ...
            if (com.example.macbookpro.advertisescreen.MainActivity.selection.contains(a)) {
                viewHolder.imageView3.setImageResource(R.drawable.tick);
            }
            else{
//                if (a == selectedPath) {
